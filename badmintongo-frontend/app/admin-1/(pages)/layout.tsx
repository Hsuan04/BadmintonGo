    ...
    return (
        <div className="min-h-screen bg-[#f5f7fb]">
            <div className="flex h-screen max-h-screen">
                {/* Sidebar */}
                <aside
                    className="hidden w-64 shrink-0 border-r border-slate-200 bg-white/95 px-4 py-5 shadow-sm md:flex md:flex-col">
                    <div className="mb-8 flex items-center gap-2 px-2">
                        <div
                            className="flex h-8 w-8 items-center justify-center rounded-xl bg-blue-600 text-sm font-semibold text-white">
                            B
                        </div>
                        <div>
                    ...
                    <nav className="flex-1 space-y-1 text-sm">
                        ...
                        <Link
                            href="/badmintongo-frontend/app/admin-1/dashboard"
              ...
              <span className="flex items-center gap-2">
                ...
                <span>Dashboard</span>
                        ...
                        <Link
                            href="/badmintongo-frontend/app/admin-1/court"
                            className="group flex items-center justify-between rounded-lg px-3 py-2 text-slate-700 transition hover:bg-slate-100"
                        >
              <span className="flex items-center gap-2">
                ...
                <span>球場管理</span>
                    ...
                    <div
                        className="mt-6 rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-3 text-xs text-slate-500">
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                    {/* Header */}
                    <header
                        className="flex h-16 items-center justify-between border-b border-slate-200 bg-white/90 px-4 shadow-sm backdrop-blur-sm md:px-6">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                className="hidden cursor-pointer items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-medium text-slate-700 shadow-sm hover:bg-slate-100 md:inline-flex">
                                <RefreshCw size={14}/>
                                Refresh
                            </button>
                            ...
                            <div className="flex items-center gap-3">
                                {/* 使用者頭像區 */}
                                <div
                                    className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1.5">
